(function () {
  const categories = [
    ...
    {
      title: 'Text & Semantic Extraction',
      icon: '✂️',
      apps: [
    ...
    },
    {
      ...
      apps: [
        ...
        { slug: 'watchlist-calendar', label: 'Watchlist Calendar' },
      ],
    },
    {
      title: 'Entities, Contacts & Numbers',
      icon: '🗂️',
      apps: [
    ...
    {
      title: 'Media Downloaders & Audio',
      icon: '📥',
      apps: [
        { slug: 'audio-only-extractor', label: 'Audio Only Extractor' },
        { slug: 'audiobook-chapter-downloader', label: 'Audiobook Chapter Downloader' },
        { slug: 'podcast-episode-downloader', label: 'Podcast Episode Downloader' },
        { slug: 'voice-message-extractor', label: 'Voice Message Extractor' },
        ...
        { slug: 'youtube-shorts-downloader', label: 'YouTube Shorts Downloader' },
        { slug: 'VimeoVideoDownloader', label: 'Vimeo Video Downloader' },
        { slug: 'facebook-reel-downloader', label: 'Facebook Reel Downloader' },
        { slug: 'instagram-post-extractor', label: 'Instagram Post Extractor' },
      ],
    },
  ];
